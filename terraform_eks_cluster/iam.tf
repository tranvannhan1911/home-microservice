...
# Allow interact with network interface of the instance, allow read some EC2 instance infomation
...
resource "aws_iam_role_policy_attachment" "iam_role_node_group-AmazonEC2ContainerRegistryReadOnly" {
